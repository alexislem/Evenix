...
import { Calendar, MapPin, Euro, Users, Search, CheckCircle, Clock, Filter, ArrowUpDown } from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        ...
        {processedEvents.length === 0 ? (
          <div className="text-center py-20 bg-gray-800/30 rounded-xl border border-dashed border-gray-700">
            ...
            <button 
                onClick={() => {setSearchTerm(''); setSelectedType('all'); setSortOption('date');}}
