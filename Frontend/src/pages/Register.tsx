...
const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
  ...
  // Filtrer uniquement les chiffres pour le téléphone
  if (name === 'telephone') {
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Nom"
                  className="w-full pl-10 pr-4 py-3 bg-gray-900 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500" required />
              </div>
              <div className="relative">
                <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-500" />
                <input
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full pl-10 pr-4 py-3 bg-gray-900 border border-gray-700 rounded-lg text-white [color-scheme:dark] focus:outline-none focus:ring-2 focus:ring-green-500" required />
              </div>
            </div>
