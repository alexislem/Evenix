...
import { Calendar, Trash2, MapPin, Euro, Users, Edit2, Check, X, UserCheck } from 'lucide-react';
                                ...
                                <div className="flex items-start justify-between">
                                    <div className="flex-1">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                                            ...
                                            {/* --- PRIX / CAPACITÉ / INSCRITS --- */}
                                            <div className="col-span-1">
                                                <p className="text-gray-500 text-xs uppercase mb-1">Infos</p>
                                                {isEditing ? (
                                                    <div className="flex items-center">
                                                        {/* ... (Ton code d'édition du prix reste inchangé) ... */}
                                                        <input
                                                            type="number"
                                                            name="prix"
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-gray-400 flex items-center text-xs mt-1">
                                                            ...
                                                            Capacité : {event.lieu?.capaciteMax || 'N/A'}
                                                        </p>

                                                        {/*Nombre d'inscrits */}
                                                        <p className="text-blue-400 flex items-center text-xs mt-1 font-medium">
                                                            <UserCheck className="w-3 h-3 mr-1" />
                                                            {event.inscriptions?.length || 0} inscrit(s)
                                                        </p>
                                                    </div>
                                                )}
                                            </div>
